...
class FlightClient(pyarrow.lib._Weakrefable):
    __pyx_vtable__: ClassVar[PyCapsule] = ...
    def __init__(self, *args, **kwargs) -> None: ...
    def authenticate(self, auth_handler, FlightCallOptionsoptions: FlightCallOptions = ...) -> Any: ...
    def authenticate_basic_token(self, username, password, FlightCallOptionsoptions: FlightCallOptions = ...) -> Any: ...
    def close(self) -> Any: ...
    @classmethod
    def connect(cls, typecls, location, tls_root_certs = ..., cert_chain = ..., private_key = ..., override_hostname = ..., disable_server_verification = ...) -> Any: ...
    def do_action(self, action, FlightCallOptionsoptions: FlightCallOptions = ...) -> Any: ...
    def do_exchange(self, FlightDescriptordescriptor: FlightDescriptor, FlightCallOptionsoptions: FlightCallOptions = ...) -> Any: ...
    def do_get(self, Ticketticket: Ticket, FlightCallOptionsoptions: FlightCallOptions = ...) -> Any: ...
    def do_put(self, FlightDescriptordescriptor: FlightDescriptor, Schemaschema: Schema, FlightCallOptionsoptions: FlightCallOptions = ...) -> Any: ...
    def get_flight_info(self, FlightDescriptordescriptor: FlightDescriptor, FlightCallOptionsoptions: FlightCallOptions = ...) -> Any: ...
    def get_schema(self, FlightDescriptordescriptor: FlightDescriptor, FlightCallOptionsoptions: FlightCallOptions = ...) -> Any: ...
    def list_actions(self, FlightCallOptionsoptions: FlightCallOptions = ...) -> Any: ...
    def list_flights(self, bytescriteria: bytes = ..., FlightCallOptionsoptions: FlightCallOptions = ...) -> Any: ...
...
class FlightServerBase(pyarrow.lib._Weakrefable):
    ...
    def do_put(self, context, descriptor, MetadataRecordBatchReaderreader: MetadataRecordBatchReader, FlightMetadataWriterwriter: FlightMetadataWriter) -> Any: ...
...
class FlightWriteSizeExceededError(pyarrow.lib.ArrowInvalid):
    def __init__(self, message, limit, actual) -> Any: ...
...
class MetadataRecordBatchWriter(pyarrow.lib._CRecordBatchWriter):
    ...
    @classmethod
    def __init__(cls, *args, **kwargs) -> None: ...
    def begin(self, Schemaschema: Schema, options = ...) -> Any: ...
    def close(self) -> Any: ...
...
class TracingServerMiddleware(ServerMiddleware):
    ...
    trace_context: Any
    def __init__(self, trace_context) -> Any: ...
...
def __pyx_unpickle_FlightUnauthenticatedError(__pyx_type, long__pyx_checksum, __pyx_state) -> Any: ...
...
def __pyx_unpickle_TracingServerMiddlewareFactory(__pyx_type, long__pyx_checksum, __pyx_state) -> Any: ...
def __pyx_unpickle__ServerMiddlewareFactoryWrapper(__pyx_type, long__pyx_checksum, __pyx_state) -> Any: ...
def __pyx_unpickle__ServerMiddlewareWrapper(__pyx_type, long__pyx_checksum, __pyx_state) -> Any: ...
