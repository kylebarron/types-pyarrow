...
class Dataset(pyarrow.lib._Weakrefable):
    ...
    def join(self, right_dataset, keys, right_keys = ..., join_type = ..., left_suffix = ..., right_suffix = ..., coalesce_keys = ..., use_threads = ...) -> Any: ...
...
class DirectoryPartitioning(KeyValuePartitioning):
    __pyx_vtable__: ClassVar[PyCapsule] = ...
    def __init__(self, *args, **kwargs) -> None: ...
    def discover(self, field_names = ..., infer_dictionary = ..., max_partition_dictionary_size = ..., schema = ..., segment_encoding = ...) -> Any: ...
    def __reduce__(self) -> Any: ...
    def __setstate__(self, state) -> Any: ...
...
class FileSystemDataset(Dataset):
    ...
    def __init__(self, *args, **kwargs) -> None: ...
    @classmethod
    def from_paths(cls, typecls, paths, schema = ..., format = ..., filesystem = ..., partitions = ..., root_partition = ...) -> Any: ...
    def __reduce__(self) -> Any: ...
...
class FilenamePartitioning(KeyValuePartitioning):
    __pyx_vtable__: ClassVar[PyCapsule] = ...
    def __init__(self, *args, **kwargs) -> None: ...
    def discover(self, field_names = ..., infer_dictionary = ..., schema = ..., segment_encoding = ...) -> Any: ...
    def __reduce__(self) -> Any: ...
    def __setstate__(self, state) -> Any: ...
...
class HivePartitioning(KeyValuePartitioning):
    __pyx_vtable__: ClassVar[PyCapsule] = ...
    def __init__(self, *args, **kwargs) -> None: ...
    def discover(self, infer_dictionary = ..., max_partition_dictionary_size = ..., null_fallback = ..., schema = ..., segment_encoding = ...) -> Any: ...
    def __reduce__(self) -> Any: ...
    def __setstate__(self, state) -> Any: ...
...
class Scanner(pyarrow.lib._Weakrefable):
    ...
    def from_batches(self, source, Schemaschema = ..., booluse_threads = ..., use_async = ..., MemoryPoolmemory_pool = ..., columns = ..., Expressionfilter = ..., intbatch_size = ..., FragmentScanOptionsfragment_scan_options = ...) -> Any: ...
    def from_dataset(self, Datasetdataset, booluse_threads = ..., use_async = ..., MemoryPoolmemory_pool = ..., columns = ..., Expressionfilter = ..., intbatch_size = ..., intbatch_readahead = ..., intfragment_readahead = ..., FragmentScanOptionsfragment_scan_options = ...) -> Any: ...
    def from_fragment(self, Fragmentfragment, Schemaschema = ..., booluse_threads = ..., use_async = ..., MemoryPoolmemory_pool = ..., columns = ..., Expressionfilter = ..., intbatch_size = ..., intbatch_readahead = ..., FragmentScanOptionsfragment_scan_options = ...) -> Any: ...
...
def _filesystemdataset_write(Scannerdata, base_dir, unicodebasename_template, FileSystemfilesystem, Partitioningpartitioning, FileWriteOptionsfile_options, intmax_partitions, file_visitor, unicodeexisting_data_behavior, intmax_open_files, intmax_rows_per_file, intmin_rows_per_group, intmax_rows_per_group, boolcreate_dir) -> Any: ...
