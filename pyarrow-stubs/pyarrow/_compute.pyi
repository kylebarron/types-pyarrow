...
class CastOptions(_CastOptions):
    def __init__(self, *args, **kwargs) -> None: ...
    def safe(self, target_type = ...) -> Any: ...
    def unsafe(self, target_type = ...) -> Any: ...
...
class DictionaryEncodeOptions(_DictionaryEncodeOptions):
    def __init__(self, null_encoding = ...) -> Any: ...
...
class Expression(pyarrow.lib._Weakrefable):
    ...
    def _deserialize(self, Bufferbuffer) -> Any: ...
    def _field(self, name_or_idx) -> Any: ...
    def _nested_field(self, tuplenames) -> Any: ...
    def _scalar(self, value) -> Any: ...
...
class FilterOptions(_FilterOptions):
    def __init__(self, null_selection_behavior = ...) -> Any: ...
...
class Function(pyarrow.lib._Weakrefable):
    ...
    num_kernels: Any
    def __init__(self, *args, **kwargs) -> None: ...
    def call(self, args, FunctionOptionsoptions = ..., MemoryPoolmemory_pool = ..., length = ...) -> Any: ...
    def __reduce__(self) -> Any: ...
...
class JoinOptions(_JoinOptions):
    def __init__(self, null_handling = ..., null_replacement = ...) -> Any: ...
...
class MapLookupOptions(_MapLookupOptions):
    def __init__(self, query_key, occurrence) -> Any: ...
...
class PadOptions(_PadOptions):
    def __init__(self, width, padding = ...) -> Any: ...
...
class StrftimeOptions(_StrftimeOptions):
    def __init__(self, format = ..., locale = ...) -> Any: ...

class StrptimeOptions(_StrptimeOptions):
    def __init__(self, format, unit, error_is_null = ...) -> Any: ...
...
class TrimOptions(_TrimOptions):
    def __init__(self, characters) -> Any: ...
...
class _CastOptions(FunctionOptions):
    ...
    @classmethod
    def __init__(cls, *args, **kwargs) -> None: ...
    def _set_options(self, DataTypetarget_type, allow_int_overflow, allow_time_truncate, allow_time_overflow, allow_decimal_truncate, allow_float_truncate, allow_invalid_utf8) -> Any: ...
...
class _RoundTemporalOptions(FunctionOptions):
    ...
    @classmethod
    def __init__(cls, *args, **kwargs) -> None: ...
    def _set_options(self, multiple, unit, week_starts_monday, ceil_is_strictly_greater, calendar_based_origin) -> Any: ...
    def __reduce__(self) -> Any: ...
    def __setstate__(self, state) -> Any: ...
...
class _WeekOptions(FunctionOptions):
    ...
    @classmethod
    def __init__(cls, *args, **kwargs) -> None: ...
    def _set_options(self, week_starts_monday, count_from_zero, first_week_is_fully_in_year) -> Any: ...
    def __reduce__(self) -> Any: ...
    def __setstate__(self, state) -> Any: ...
