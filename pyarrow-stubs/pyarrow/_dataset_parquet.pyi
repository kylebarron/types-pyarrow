...
class ParquetFileFormat(pyarrow._dataset.FileFormat):
    ...
    def make_fragment(self, file, filesystem = ..., Expressionpartition_expression = ..., row_groups = ...) -> Any: ...
...
class ParquetReadOptions(pyarrow.lib._Weakrefable):
    ...
    _coerce_int96_timestamp_unit: _coerce_int96_timestamp_unit
...
class RowGroupInfo:
    __hash__: ClassVar[None] = ...
    def __init__(self, id, metadata, schema) -> Any: ...
    def __eq__(self, other) -> Any: ...
    @property
