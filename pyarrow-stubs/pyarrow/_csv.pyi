...
def open_csv(input_file, read_options = ..., parse_options = ..., convert_options = ..., MemoryPoolmemory_pool = ...) -> Any: ...
@overload
def read_csv(input_file, read_options = ..., parse_options = ..., convert_options = ..., MemoryPoolmemory_pool = ...) -> Any: ...
@overload
